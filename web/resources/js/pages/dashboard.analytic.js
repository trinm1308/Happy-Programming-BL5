...
class DashboardAnalytic {
    ...
    _initCustomLegendBarChart() {
        if (document.getElementById('customLegendBarChart')) {
            ...
            var dataName = "";
            $.ajax({
                url: '/admin?action=getDataChart4',
                async: false,
                type: 'POST',
                success: function (response) {
                    ...
                    $.ajax({
                        url: '/admin?action=getCategoryNameChart4',
                        async: false,
                        type: 'POST',
                        success: function (response) {
                            dataName = JSON.parse(response);
                                ...
                                data: {
                                    ...
                                    datasets: [
                                        ...
                                        },
                                        {
                                            ...
                                            borderWidth: 2,
                                            data: [parseInt(data[8]), parseInt(data[9]), parseInt(data[10]), parseInt(data[11]), parseInt(data[12]), parseInt(data[13])],
                                        },
                                    ],
                                    icons: ['loaf', 'cupcake'],
                                },
    ...
    _initSmallDoughnutCharts() {
        ...
        var dataName = "";
        $.ajax({
            url: '/admin?action=getThirdChart',
            async: false,
            type: 'POST',
            success: function (response) {
                data = JSON.parse(response);
                ...
                $.ajax({
                    url: '/admin?action=getCategoryChart',
                    async: false,
                    type: 'POST',
                    success: function (response) {
                        dataName = JSON.parse(response);
                        ...
                        if (document.getElementById('smallDoughnutChart1')) {
                            this._smallDoughnutChart1 = ChartsExtend.SmallDoughnutChart('smallDoughnutChart1', [parseInt(data[0]), parseInt(data[6]) - parseInt(data[0])], dataName[0]);
                        }
                        if (document.getElementById('smallDoughnutChart2')) {
                            this._smallDoughnutChart2 = ChartsExtend.SmallDoughnutChart('smallDoughnutChart2', [parseInt(data[1]), parseInt(data[6]) - parseInt(data[1])], dataName[1]);
                        }
                        if (document.getElementById('smallDoughnutChart3')) {
                            this._smallDoughnutChart3 = ChartsExtend.SmallDoughnutChart('smallDoughnutChart3', [parseInt(data[2]), parseInt(data[6]) - parseInt(data[2])], dataName[2]);
                        }
                        if (document.getElementById('smallDoughnutChart4')) {
                            this._smallDoughnutChart4 = ChartsExtend.SmallDoughnutChart('smallDoughnutChart4', [parseInt(data[3]), parseInt(data[6]) - parseInt(data[3])], dataName[3]);
                        }
                        if (document.getElementById('smallDoughnutChart5')) {
                            this._smallDoughnutChart5 = ChartsExtend.SmallDoughnutChart('smallDoughnutChart5', [parseInt(data[4]), parseInt(data[6]) - parseInt(data[4])], dataName[4]);
                        }
                        if (document.getElementById('smallDoughnutChart6')) {
                            this._smallDoughnutChart6 = ChartsExtend.SmallDoughnutChart('smallDoughnutChart6', [parseInt(data[5]), parseInt(data[6]) - parseInt(data[5])], dataName[5]);
                        }
                    }
                });
            }

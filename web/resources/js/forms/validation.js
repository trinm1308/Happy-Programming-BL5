  ...
  _initCommonRules() {
    jQuery('#rulesForm').validate({
      ...
      messages: {
        ...
        rulesEmail: {
          email: 'bạn phải điền đúng định dạng email!',
        },
        rulesId: {
          number: 'Bạn phải nhập số !',
          minlength: 'Bạn phải điền ít nhất {0} kí tự!',
          maxlength: 'Bạn không được nhập quá {0} kí tự!',
        },
        rulesPassword: {
          minlength: 'Mật khẩu phải chứa ít nhất {0} kí tự!',
        },
        rulesPasswordConfirm: {
